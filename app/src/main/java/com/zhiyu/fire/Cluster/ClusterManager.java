...
/**
 * Created by xiaow on 2017/6/23 14:59.
 */
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    private OnReLoadMarkersListener mOnReLoadMarkersListener;

    Handler handler;
    int result;

    public ClusterManager(Context context, BaiduMap map, OnReLoadMarkersListener mOnReLoadMarkersListener) {
        this(context, map, new MarkerManager(map));
        this.mOnReLoadMarkersListener = mOnReLoadMarkersListener;
    }
...
//        Log.d("test", target.toString());
        clearItems();
        mOnReLoadMarkersListener.OnReLoadMarkers(target.longitude, target.latitude);
    }
    ...
    public interface OnReLoadMarkersListener {
        public void OnReLoadMarkers(double x, double y);
    }
}